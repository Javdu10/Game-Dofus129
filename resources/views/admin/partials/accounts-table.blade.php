...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input type="text" class="form-control" id="ainputUsernameCol" placeholder="username">
    </div>
</div>
<div class="form-group row">
    <label for="ainputPasswordCol" class="col-sm-2 col-form-label">Password column :</label>
    <div class="col-sm-10">
        <input type="text" class="form-control" id="ainputPasswordCol" placeholder="password">
    </div>
</div>
<div class="form-group row">
    <label for="ainputPseudoCol" class="col-sm-2 col-form-label">Pseudo column :</label>
    <div class="col-sm-10">
        <input type="text" class="form-control" id="ainputPseudoCol" placeholder="pseudo">
    </div>
</div>
<div class="form-group row">
    <label for="ainputQuestionCol" class="col-sm-2 col-form-label">Question column :</label>
    <div class="col-sm-10">
        <input type="text" class="form-control" id="ainputQuestionCol" placeholder="question">
    </div>
</div>
<div class="form-group row">
    <label for="ainputAnswerCol" class="col-sm-2 col-form-label">Answer column :</label>
    <div class="col-sm-10">
        <input type="text" class="form-control" id="ainputAnswerCol" placeholder="answer">
    </div>
</div>
